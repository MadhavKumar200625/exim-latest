<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sitemap-global-companies.aspx.cs" Inherits="sitemap_global_companies" %>
            ...
            <section class="about_sections">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <asp:HiddenField ID="hid_max" runat="server" Value="1" /> 
                    </div>
                </div>
            </section>
                            ...
                            <div class="search-data">
                                <div class="search-form-block position-relative">
                                    <div class="row" style="min-height: 600px !important;">
                                        ...
                                        <div class="col-md-1 col-sm-6">
                                            <div class="form-group-lg fg-1">
                                                <asp:TextBox ID="txtto" runat="server" placeholder="Record To" Text="5000" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2 col-sm-6">
                                            <div class="form-group-lg fg-1">
                                                <asp:TextBox ID="txttotal" runat="server" CssClass="form-control dropss" Text="10">
                                                </asp:TextBox>
                                            </div>
                                        </div>
